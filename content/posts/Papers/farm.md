...
_Why do companies (Microsoft, Google, Facebook, Yahoo, etc) publish papers about their software, rather than keeping their designs secret?_
...
_What are some limitations of FaRM?_
...
_What is the distinction between primaries, backups, and
configuration managers in FaRM? Why are there three roles?_
